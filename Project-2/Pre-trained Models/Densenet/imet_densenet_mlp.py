# -*- coding: utf-8 -*-
"""
In this kernel, we are going to use Densenet121 pretrained model with Pytorch and Multilayer perceptron.
"""
...
labels = pd.read_csv("imet-2019-fgvc6/labels.csv")
train = pd.read_csv("imet-2019-fgvc6/train.csv")
sample = pd.read_csv("imet-2019-fgvc6/sample_submission.csv")
